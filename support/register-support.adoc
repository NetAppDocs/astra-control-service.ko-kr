...
.단계
. 로 이동합니다 https://register.netapp.com["클라우드 데이터 서비스 지원 등록"^] 페이지.
...
.. 제품 라인으로 * Astra Control Service * 를 선택합니다.
.. 청구 공급자를 선택합니다.
.. 일련 번호를 입력합니다.
.. 제출 * 을 선택합니다.
...
. 양식에 필요한 정보를 입력합니다.
+
.. 이름, 회사 정보 및 연락처 정보를 입력합니다.
.. 제품 라인으로 * Astra Control Service * 를 선택합니다.
.. 청구 공급자를 선택합니다.
.. 일련 번호를 입력합니다.
.. captcha 값을 입력합니다.
.. 확인란을 선택하여 NetApp 개인 정보 보호 정책을 읽었는지 확인합니다.
.. 제출 * 을 선택합니다.
+
