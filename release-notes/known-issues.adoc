...
== 삭제된 응용 프로그램을 복원하려고 하면 응용 프로그램 페이지가 영구적으로 로드됩니다

응용 프로그램 페이지를 사용하여 삭제된 클러스터에서 앱을 복원하려고 하면 응용 프로그램 페이지 로드가 완료되지 않습니다. 이 문제를 해결하려면 응용 프로그램 목록의 앱 작업 메뉴에서 앱을 복원하십시오.
