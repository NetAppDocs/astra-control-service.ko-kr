...
=== NetApp Cloud Volumes ONTAP은 Amazon Web Services에 대해 공식적으로 지원되지 않습니다

2023년 1월 17일 Astra Control Service의 릴리즈 현재 NetApp Cloud Volumes ONTAP은 Amazon Web Services에 대해 아직 공식적으로 지원되지 않습니다.
