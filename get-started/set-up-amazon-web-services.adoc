...
아스트라 트리덴트:: 스토리지 백엔드가 있는 작업에는 Astra Trident와 외부 스냅샷 컨트롤러가 필요합니다. 설치하려면 다음을 수행합니다.
...
====
.외부 스냅샷 프로그램을 설치합니다
아직 수행하지 않았다면 https://docs.netapp.com/us-en/trident/trident-use/vol-snapshots.html#deploying-a-volume-snapshot-controller["스냅샷 CRD 및 스냅샷 컨트롤러를 설치합니다"^].
