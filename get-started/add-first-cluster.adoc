...
* NetApp 스토리지를 사용 중이거나 사용할 계획인 경우, Astra Trident의 버전이 설치되었는지 확인합니다 link:../get-started/requirements.html#operational-environment-requirements["Astra Control Service에서 지원합니다"^]:
+
