...
예, Astra Control Service에 프라이빗 클러스터를 추가할 수 있습니다. GKE(Google Kubernetes Engine) 프라이빗 클러스터를 생성하려면 https://kb.netapp.com/Advice_and_Troubleshooting/Cloud_Services/Project_Astra/How_to_create_a_private_GKE_cluster_to_work_with_project_Astra["이 기술 자료 문서의 지침을 따르십시오"^].
