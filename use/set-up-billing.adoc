...
* https://["Cloud Volumes Service에 대한 가격 세부 정보를 봅니다"^].
+
Astra Control Service는 모든 서비스 유형과 서비스 수준을 지원합니다. 사용하는 서비스 유형은 에 따라 다릅니다 https://["Google Cloud 지역"^].

* https://["Google Cloud 스토리지 버킷의 가격 세부 정보를 확인하십시오"^].
...
* https://["Azure NetApp Files에 대한 가격 세부 정보를 봅니다"^].
* https://["Microsoft Azure Blob 스토리지의 가격 세부 정보를 봅니다"^].
...
* https://["Amazon Web Services에 대한 가격 세부 정보를 봅니다"^].
...
NOTE: Azure Marketplace 구독 프로세스에 대한 비디오 안내를 보려면 를 방문하십시오 https://["NetApp TV를 참조하십시오"^].

.단계
. 로 이동합니다 https://["Azure 마켓플레이스 를 참조하십시오"^].
. 지금 다운로드 * 를 선택합니다.
. 지침에 따라 계획을 구독합니다.
...
.단계
. 로 이동합니다 https://["AWS 마켓플레이스 를 참조하십시오"^].
