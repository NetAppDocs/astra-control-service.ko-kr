...
* * 스토리지 백엔드 *:
+
** Astra Control Service가 사용합니다 https://www.netapp.com/cloud-services/azure-netapp-files/["Azure NetApp Files"^] AKS 클러스터의 스토리지 백엔드로 사용됩니다.
** Astra Control Service는 백엔드 스토리지 옵션으로 Azure Managed Disks도 지원합니다.
...
* Astra Control Service가 사용합니다 https://www.netapp.com/cloud-services/cloud-volumes-service-for-google-cloud/["Google Cloud용 NetApp Cloud Volumes Service"^] GKE 클러스터를 위한 스토리지 백엔드로 사용됩니다.
* Astra Control Service는 백엔드 스토리지 옵션으로 Google Persistent Disk도 지원합니다.
